defmodule GarageGenieWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GarageGenieWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GarageGenieWeb.Gettext, "errors", msg, opts)
    end
  end
